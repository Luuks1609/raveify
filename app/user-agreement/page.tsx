      ...
      <MaxWidthWrapper>
        <div className="leading-relaxed">
          ...
          <section className="mb-4">
            ...
            <p>
              Welcome to Raveify ("the Application"), a platform that allows
              users to create Spotify playlists based on music event lineups. By
              using Raveify, you agree to comply with and be bound by this End
              User Agreement ("Agreement"). If you do not agree to this
              Agreement, you must not use the Application.
            </p>
          </section>
          <section className="mb-4">
          ...
          <section className="mb-4">
            ...
            <p>
              ...
              Spotify API endpoints. Your use of Spotify’s services is governed
              by Spotify’s own terms and conditions. Raveify is not responsible
              for any actions taken on your Spotify account.
            </p>
          </section>
          <section className="mb-4">
          ...
          <section className="mb-4">
            ...
            <p>
              Raveify is provided "as is" without warranties of any kind. We do
              not guarantee that the Application will be error-free, secure, or
              uninterrupted. To the fullest extent permitted by law, Raveify
              disclaims liability for any indirect, incidental, or consequential
